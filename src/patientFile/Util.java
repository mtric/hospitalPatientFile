...
/**
 * Diese Klasse stellt verschiedene Hilfsfunktionen zur Verfuegung
 *
...
public class Util {
  ...
  /**
  * Gibt ein Connection-Objekt aus dem Pool zurueck
  ...
  */
  ...
  /**
   * Gibt eine Referenz auf einen Managed Bean zurueck
  ...
  /**
   * Verschluesselung eines Passworts
   * Aus Kennung und Passwort wird mittels SHA-Hash das verschluesselete Passwort
   * generiert. 
   * @param user Kennung
   * @param pw   Passwort im Klartext
   * @return out Verschluesseltes Passwort oder unverschluesselte 
